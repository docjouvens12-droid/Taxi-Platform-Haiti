...
const HT: Topic[] = [
  ...
  ['GPS ak pozisyon','Pou resevwa ak jere trajè, aktive Location/GPS sou telefòn ou epi bay MOVI pèmisyon pou itilize pozisyon an. Si kat la montre move kote, verifye GPS la, deplase nan yon zòn ki gen pi bon siyal epi relouvri paj la. Pa fèmen GPS pandan yon trajè aktif.'],
...
const FR: Topic[] = [
  ...
  ['GPS et localisation','Activez la localisation du téléphone et autorisez MOVI à utiliser votre position. Si la carte affiche une mauvaise position, vérifiez le GPS, améliorez le signal si possible et rechargez la page. Ne désactivez pas le GPS pendant un trajet actif.'],
