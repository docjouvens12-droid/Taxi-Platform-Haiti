...
const TOPICS: Topic[] = [
  ...
  { icon:'📍', category:'technical', fr:'GPS ou position incorrecte', ht:'GPS oswa pozisyon pa bon', bodyFr:'Activez la localisation du téléphone et autorisez MOVI à utiliser votre position. Si le point reste incorrect, désactivez puis réactivez la localisation, vérifiez votre connexion et actualisez la page une fois.', bodyHt:'Aktive Location sou telefòn ou epi bay MOVI pèmisyon pou itilize pozisyon an. Si pozisyon an toujou pa bon, fè Location la off/on, verifye entènèt la epi rafrechi paj la yon fwa.' },
  ...
  { icon:'📱', category:'technical', fr:'L’application semble bloquée sur iPhone', ht:'Aplikasyon an sanble bloke sou iPhone', bodyFr:'Fermez complètement la page ou l’onglet puis ouvrez de nouveau le lien principal de MOVI. Si le problème revient, notez l’écran concerné et envoyez une capture au support.', bodyHt:'Fèmen paj oswa tab la nèt epi relouvri lyen prensipal MOVI a. Si pwoblèm nan retounen, note ki ekran ki bloke a epi voye yon screenshot bay sipò.' },
  ...
  { icon:'🧭', category:'support', fr:'Quand contacter les services d’urgence', ht:'Kilè pou kontakte sèvis ijans', bodyFr:'Le support de MOVI ne remplace pas les services d’urgence. En cas de danger immédiat, blessure grave, violence ou menace en cours, contactez d’abord les services d’urgence locaux, puis la plateforme lorsque vous êtes en sécurité.', bodyHt:'Sipò MOVI pa ranplase sèvis ijans. Si gen danje imedya, gwo blesi, vyolans oswa menas k ap fèt, kontakte sèvis ijans lokal yo an premye, epi kontakte platfòm nan lè ou an sekirite.' },
]
  ...
  return createPortal(
    <section className="passenger-help-center">
      ...
      <div className="passenger-help-emergency">
        <span>🚨</span>
        <div><strong>{ht ? 'Ijans oswa danje imedya' : 'Urgence ou danger immédiat'}</strong><small>{ht ? 'Kontakte sèvis ijans lokal yo an premye. Sipò MOVI pa ranplase sèvis ijans.' : 'Contactez d’abord les services d’urgence locaux. Le support MOVI ne remplace pas les services d’urgence.'}</small></div>
      </div>
