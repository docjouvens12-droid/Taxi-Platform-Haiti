...
export default function RideCommunicationPanel() {
  ...
  return <>
    ...
    <style jsx>{`
      ...
      .rideComActions button{border:1px solid #dce6f3;border-radius:14px;min-width:105px;height:44px;padding:0 14px;font:800 12px Inter,system-ui,sans-serif;box-shadow:0 8px 18px rgba(16,32,51,.12);display:flex;align-items:center;justify-content:center;gap:6px}
